...
TEST_F(AlgoTypeTest, stringToEnumSuccess)
{
    ...
    EXPECT_EQ(algo::toEnum("randomx"), algo::ALGORITHM::RANDOMX);
    EXPECT_EQ(algo::toEnum("rx/0"), algo::ALGORITHM::RANDOMX);
...
TEST_F(AlgoTypeTest, stringToEnumFail)
{
    ...
    EXPECT_NE(algo::toEnum("progpowz"), algo::ALGORITHM::PROGPOW);
